    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
                   v-hasPermi="['sms:channel:add']">新增</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="渠道编码" align="center" prop="code">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_sms_channel_code" :value="scope.row.code"/>
        </template>
      </el-table-column>>
      ...
      <el-table-column label="短信 API 的账号(加密)" :show-overflow-tooltip="true" align="center" prop="apiKey" />
      <el-table-column label="短信 API 的秘钥(加密)" :show-overflow-tooltip="true" align="center" prop="apiSecret" />
      <el-table-column label="短信发送回调 URL" :show-overflow-tooltip="true" align="center" width="140px" prop="callbackUrl" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)"
                     v-hasPermi="['sms:channel:edit']">修改</el-button>
          <el-button size="mini" type="text" icon="el-icon-delete" @click="handleDelete(scope.row)"
                     v-hasPermi="['sms:channel:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页组件 -->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="150px">
        ...
        <el-form-item label="渠道编码" prop="code">
          <el-input :disabled="true" v-model="form.code" placeholder="请输入渠道编码" />
        </el-form-item>
...
<script>
import { createSmsChannel, updateSmsChannel, deleteSmsChannel, getSmsChannelPage } from "@/api/system/sms/smsChannel";

export default {
  name: "SmsChannel",
  dicts: ['sys_normal_disable','sys_sms_channel_code'],
  components: {
  },
  data() {
    return {
