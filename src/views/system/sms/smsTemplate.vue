  ...
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="96px">
      <el-form-item label="短信类型" prop="type">
        <el-select  style="width: 240px" v-model="queryParams.type" placeholder="请选择短信类型" clearable size="small">
          <el-option v-for="dict in dict.type.sys_sms_template_type"
                     :key="dict.value" :label="dict.label" :value="dict.value"/>
        </el-select>
      </el-form-item>
      <el-form-item label="开启状态" prop="status">
        <el-select style="width: 240px" v-model="queryParams.status" placeholder="请选择开启状态" clearable size="small">
          <el-option v-for="dict in dict.type.sys_normal_disable"
                     :key="dict.value" :label="dict.label" :value="dict.value"/>
        </el-select>
      </el-form-item>
      <el-form-item label="模板编码" prop="code">
        <el-input style="width: 240px" v-model="queryParams.code" placeholder="请输入模板编码" clearable size="small" @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="API模板编号" prop="apiTemplateId">
        <el-input style="width: 240px" v-model="queryParams.apiTemplateId" placeholder="请输入短信 API 的模板编号" clearable size="small" @keyup.enter.native="handleQuery"/>
      </el-form-item>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="150">
        <template slot-scope="scope">
          <el-button size="mini" type="text" icon="el-icon-share" @click="handleSendSms(scope.row)"
                     v-hasPermi="['sms:template:send-sms']">测试</el-button>
...
<script>
import { createSmsTemplate, updateSmsTemplate, deleteSmsTemplate, getSmsTemplatePage,
